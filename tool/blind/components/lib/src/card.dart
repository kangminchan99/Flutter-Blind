                      ...
                      child: Row(
                        children: [
                          ...
                          if (thumbnailUrls.isNotEmpty) ...[
                            ...
                            BlindThumbnailImage(imageUrls: thumbnailUrls),
                          ],
                        ],
                      ),
                    ),
...
class BlindLoadingPostCard extends StatelessWidget {
  const BlindLoadingPostCard({super.key});
