...
class BlindThumbnailImage extends StatelessWidget {
...
class BlindProfileImage extends StatelessWidget {
        ...
        child: DecoratedBox(
          ...
          child: Center(
            child: imageUrl.isWebUrl
                ...
                : BlindIcon.personOn(color: context.colorScheme.gray300),
          ),
        ),
      ),
    );
